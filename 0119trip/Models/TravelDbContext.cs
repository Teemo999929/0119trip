...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\sqlexpress;Database=travelDB;Integrated Security=True;Encrypt=False;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Accommodation>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Accommod__3214EC0721D89321");
        ...
        {
            entity.HasKey(e => new { e.ItineraryItemId, e.UserId }).HasName("PK__BlindBox__CA80D4BADFE601A2");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A0B479427D3");
        ...
        {
            entity.HasKey(e => e.ExpenseId).HasName("PK__Expenses__1445CFD3295EC393");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ExpenseP__3214EC0752A84AE3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ExpenseP__3214EC07055E2F91");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Flights__3214EC0755926A77");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__GlobalRe__3214EC0784C1EE8C");
            ...
            entity.HasIndex(e => e.PlaceId, "UQ__GlobalRe__D5222B6FDD174CC8").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Itinerar__3214EC07E465D6D4");
        ...
        {
            entity.HasKey(e => e.LeaveId).HasName("PK__LeaveDat__796DB9592E858229");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Location__3214EC07616249C9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__MemberTi__3214EC074C0D6159");
        ...
        {
            entity.HasKey(e => e.SpotId).HasName("PK__PlacesSn__61645FE74AEB7E32");
            ...
            entity.HasIndex(e => e.ExternalPlaceId, "UQ__PlacesSn__577A2CE809AFBCA6").IsUnique();
        ...
        {
            entity.HasKey(e => e.Index).HasName("PK__Recomman__9A5B62283DCB8536");
        ...
        {
            entity.HasKey(e => e.SettlementId).HasName("PK__Settleme__7712545A00031A32");
        ...
        {
            entity.HasKey(e => e.GroupId).HasName("PK__TravelGr__149AF36ACD532A45");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Trips__3214EC070193583F");
        ...
        {
            entity.HasKey(e => new { e.TripId, e.RegionId }).HasName("PK__TripRegi__7B11F5741FA9FE63");
        ...
        {
            entity.HasKey(e => e.WishlistItemId).HasName("PK__Wishlist__171E21A182DA2819");
